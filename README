...
The latest version is available at <http://seansantry.com/projects/blogtags/> and from my subversion repository at <http://seansantry.com/svn/radiant/extensions/blogtags/trunk>.
